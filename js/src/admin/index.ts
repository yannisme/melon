...
app.initializers.add('yannisme/melon', () => {
  ...
  // Inject collapsible CSS
  const style = document.createElement('style');
  style.textContent = [
    // Wrapper
    '.melon-collapsible-wrapper{margin-bottom:16px;border:1px solid #e2e8f0;border-radius:10px;overflow:hidden;background:#fff}',
    ...
    '.melon-collapsible-header:hover{background:#f8fafc}',

    // Title
    '.melon-collapsible-title{font-size:14px;font-weight:600;color:#1e293b;white-space:nowrap;flex-shrink:0}',

    // Dotted separator (flex-grow)
    '.melon-collapsible-dots{flex:1;min-width:20px;margin:0 10px;border-bottom:2px dotted #cbd5e1;align-self:center;height:0}',

    // Right side container
    '.melon-collapsible-right{display:flex;align-items:center;gap:10px;flex-shrink:0}',

    // Arrow
    '.melon-collapsible-arrow{font-size:11px;color:#94a3b8;transition:transform .3s cubic-bezier(.4,0,.2,1);flex-shrink:0}',
    '.melon-collapsible-header.melon-collapsible-open .melon-collapsible-arrow{transform:rotate(180deg)}',

    // Description row
    '.melon-collapsible-desc{padding:0 16px 8px;font-size:12px;color:#64748b;line-height:1.5}',

    // Separator line
    '.melon-collapsible-sep{height:1px;background:#e2e8f0;margin:0 16px}',
    ...
    '.melon-collapsible-body>.Form-group{display:flex;flex-direction:column;padding:12px 0;border-bottom:1px solid #f1f5f9;gap:4px}',
    ...
    '.melon-collapsible-body>.Form-group>label{font-size:13px;font-weight:600;color:#1e293b;text-align:left}',
    '.melon-collapsible-body>.Form-group .helpText{font-size:11px;color:#94a3b8;padding-left:0;text-align:left;margin:0}',
    ...
    '.melon-collapsible-body>.Form-group:has(input[type="color"]) input[type="text"]{flex:1;max-width:180px;padding:6px 10px;border:1px solid #e2e8f0;border-radius:6px;font-size:13px;box-sizing:border-box}',
    '.melon-collapsible-body>.Form-group:has(input[type="color"]) input[type="color"]{width:36px;height:30px;padding:2px;border:1px solid #e2e8f0;border-radius:6px;cursor:pointer;flex-shrink:0}',

    // Select dropdown in body
    '.melon-collapsible-body>.Form-group select{width:100%;min-width:200px;padding:6px 10px;border:1px solid #e2e8f0;border-radius:6px;font-size:13px;background:#fff;color:#334155;cursor:pointer;box-sizing:border-box}',

    // Number input in body
    '.melon-collapsible-body>.Form-group input[type="number"]{width:100%;max-width:240px;padding:6px 10px;border:1px solid #e2e8f0;border-radius:6px;font-size:13px;box-sizing:border-box}',
    ...
    '.melon-collapsible-toggle-track{position:absolute;inset:0;background:#cbd5e1;border-radius:20px;transition:background .25s ease}',
