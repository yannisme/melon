...
app.initializers.add('yannisme/melon', () => {
  ...
  function applyCollapsible() {
    ...
    const labelToKey: Record<string, string> = {
      ...
      '启用首页新布局': 'category_cards_enabled',
      'Discussion Count': 'homepage_disc_count',
      '讨论显示数量': 'homepage_disc_count',
