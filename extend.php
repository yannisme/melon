...
return [
    ...
    (new Extend\Settings())
        ...
        ->default('melon.disc_floor_color_1', '')
        ->default('melon.disc_floor_icon_1', '')
        ->default('melon.disc_floor_label_2', '沙发')
        ->default('melon.disc_floor_color_2', '')
        ->default('melon.disc_floor_icon_2', '')
        ->default('melon.disc_floor_label_3', '地板')
        ->default('melon.disc_floor_color_3', '')
